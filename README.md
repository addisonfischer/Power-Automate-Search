...
This is a tool created to help search Power Automate flows, workflows, and web resources across your Dataverse environments. It started as a basic search tool and has grown with several performance optimizations and search features.
...
- **Search Content**: For Web Resources, check this to search inside file contents. Expect slightly longer search tims. Leave unchecked for faster name-only searches.
